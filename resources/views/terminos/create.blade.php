...
<body class="bg-secondary">
    ...
    <div class="container text-center bg-dark mt-2">
        <div class="row align-items-start">
          <div class="col-12">
            <Header>
                <br>
                <h3 class="display-3 text-white">Añadir un nuevo Termino</h3>
    ...
    <div class="container text-center mt-2">
        <div class="row align-items-start mt-3"><!--Row principal-->
            ...
            <form action="{{ route('terminos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <br>
                ...
                <button type="submit" class="btn btn-primary">Crear Término</button><br>
            </form><br>
            </div>
            <div class="col-3"></div>
        </div>
